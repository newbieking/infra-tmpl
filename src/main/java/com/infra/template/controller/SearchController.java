...
@Tag(name = "Search", description = "Elasticsearch index and search demo")
public class SearchController {
    ...
    @PostMapping
    public ResponseEntity<List<SearchResult>> search(@Valid @RequestBody SearchRequest request) throws IOException {
