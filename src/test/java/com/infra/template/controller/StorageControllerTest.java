...
import com.infra.template.service.StorageService;
...
class StorageControllerTest {
    ...
    @Test
    void downloadShouldReturnFileContent() throws Exception {
        InputStream stream = new ByteArrayInputStream("hello".getBytes());
        when(storageService.download("test.txt")).thenReturn(stream);
